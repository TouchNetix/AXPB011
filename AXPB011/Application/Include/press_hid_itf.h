...
/* Sentry Guard Start */
#ifndef APPLICATION_INCLUDE_PRESS_HID_ITF_H_
#define APPLICATION_INCLUDE_PRESS_HID_ITF_H_
...
typedef enum
{
    ePressPacketsBlocked = 0,
    ePressPacketsAllowed = 1U,
} enPressBlockedStatus;

/*******************************************************************************
 * Constants (including enums)
 ******************************************************************************/
#define PRESS_USB_PACKET_READY  (1U)
#define NO_PRESS_USB_PACKET     (0)
...
/* END SENTRY GUARD */
#endif /* APPLICATION_INCLUDE_PRESS_HID_ITF_H_ */
